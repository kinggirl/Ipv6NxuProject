...
def showCluster(centroidList, clusterDict):
    ...
    colorMark = ['or', 'ob', 'og', 'ok', 'oy', 'ow', 'oc']  # 不同簇类的标记 'or' --> 'o'代表圆，'r'代表red，'b':blue
    centroidMark = ['dr', 'db', 'dg', 'dk', 'dy', 'dw', 'oc']  # 质心标记 同上'd'代表棱形
    for key in clusterDict.keys():
...
if __name__ == '__main__':
    ...
    inFile = "julieshuju.csv"  # 数据集文件
    dataSet = loadDataSet(inFile)  # 载入数据集
    centroidList = initCentroids(dataSet, 7)  # 初始化质心，设置k=7
